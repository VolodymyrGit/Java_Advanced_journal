...
<html>
<head>
    <title>${sessionScope.currentUser.userName} Cabinet</title>
...
<body>
    <div class="user-data">
        ...
        <h1>Phone Number - ${sessionScope.currentUser.phoneNumber}</h1>
        <h1>Group Id - ${sessionScope.currentUser.group.id}</h1>
