...
<html>
<head>
    <title>Change ${sessionScope.currentUser.userName} Info</title>
</head>
<body>
...
<form method="post" action="/change-info">
    ...
    <label><input type="text" name="name" value="${sessionScope.currentUser.userName}"> Name</label><br>
    <label><input type="text" name="email" value="${sessionScope.currentUser.email}"> Email</label><br>
    <label><input type="text" name="phone" value="${sessionScope.currentUser.phoneNumber}"> Phone number</label><br>
    <label><input type="text" name="groupId" value="${sessionScope.currentUser.group.id}"> Group id</label><br>
